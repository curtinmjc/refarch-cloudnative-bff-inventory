module.exports = function(app, request) {
	...
	var resJson = [];
// MJC	var microserviceBaseUrl = "https://netflix-zuul-cloudnative-dev.mybluemix.net/inventory-microservice/micro";
	var microserviceBaseUrl = "https://netflix-zuul-curtinm.mybluemix.net/inventory-microservice/micro";
...
// <MJC> added if block per exercise instructions to prevent error if missing input for JSON parsing
			if (body.length === 0) {
				body = "{}";
			}
// </MJC>
